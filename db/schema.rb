...
ActiveRecord::Schema[7.0].define(version: 20_220_403_224_110) do
  ...
  create_table 'wallet_items', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[asset_id wallet_id], name: 'index_wallet_items_on_asset_id_and_wallet_id', unique: true
